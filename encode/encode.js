const color_sys_command = "#0000FF";
const color_sys_command_ignore = "#808080";
const color_sys_flowline = "#808080";
const color_sys_flowline_ignore = "#808080";
const color_assembly = "#000080"
const color_function = "#000080";
const color_dll_command = "#800000";
const color_custom_datatype = "#000080";
const color_constant = "#000080";
const color_constant_value = "#800000";
const color_datatype = "#0000FF";
const color_remark = "#008000";
const color_constant_y = "#DE61DE";

const color_code_number = "#800000";
const color_code_array = "#000080";
const color_code_quto = "#008080";
const color_code_bracket = "#000080";
const color_code_brace = "#000080";
const color_code_constant = "#000080";
const color_code_command = "#800000";
const color_code_datatype = "#DECB6B";
...
function trans(head_div_id) { //head_div_id_ecode_1/2/3...
    var p_a = -1,
        ...
        datacode = "",
        div_code_name = "";
    htmldata = document.getElementById(head_div_id)
        .innerHTML;
    p_a = htmldata.indexOf(head_div_id + "_ecode_", p_a + 1);
    while (p_a != -1) {
        n = n + 1;
        div_code_name = head_div_id + "_ecode_" + n.toString();
        datacode = document.getElementById(div_code_name)
            .innerHTML;
...
function ecode(data, divid) {
    ...
    for (a = 0; a < linetext.length; a++) {
        ...
        if (headtext == ".程序集") {
            ...
            for (b = 0; b < linecode.length; b++) {
                if (b == 0) {
                    out += "<td style='color:" + color_function + "'>";
                } else if (b == 3) {
                    out += "<td style='color:" + color_remark + "'>";
                } else {
                    out += "<td>";
                }
            ...
            for (b = 0; b < linecode.length; b++) {
                if (b == 2) {
                    ...
                    if (b == 1) {
                        out += "<td style='color:" + color_datatype + "'>";
                    } else if (b == 4) {
                        out += "<td style='color:" + color_remark + "'>";
                    } else {
                        out += "<td>";
            ...
            for (b = 0; b < 4 - linecode.length + m_blank; b++) {
                out += "<td></td>";
            }
            out += "</tr>"
            t = 1;
            ...
            for (b = 0; b < linecode.length; b++) {
                if (b == 0) {
                    ...
                    out += "<td style='color:" + color_remark + "' colspan='3'>";
                } else {
                    out += "<td>";
                }
                if (linecode[b] != undefined) {
                    if (b == 2 & trim(linecode[b]) != "") {
                        out += "√</td>";
                    } else {
                        out += linecode[b] + "</td>";
                    }
            ...
            for (b = 0; b < linecode.length; b++) {
                if (b == 0) {
                    temp += "<td style='color:" + color_function + "'>" + linecode[b] + "</td>";
                } else if (b == 1) {
                    temp += "<td style='color:" + color_datatype + "'>" + linecode[b] + "</td>";
                } else if (b == 2) {
                    linecode[b] = linecode[b].replace(/["]/g, "");
            ...
            for (b = 0; b < linecode.length; b++) {
                ...
                if (b == 2) {
                    ...
                    if (linecode[b] == "参考") {
                        out += "√</td><td></td><td></td>"
                    } else if (linecode[b] == "可空") {
                        out += "</td><td>√</td><td></td>"
                    } else if (linecode[b] == "数组") {
                        out += "</td><td></td><td>√</td>"
                    } else if (linecode[b] == "参考 可空") {
                        out += "√</td><td>√</td><td></td>"
                    } else if (linecode[b] == "可空 数组") {
                        out += "</td><td>√</td><td>√</td>"
                    } else if (linecode[b] == "参考 数组") {
                        out += "√</td><td></td><td>√</td>"
                    } else if (linecode[b] == "参考 可空 数组") {
                        out += "√</td><td>√</td><td>√</td>"
                    } else {
                        out += "</td><td></td><td></td>"
                    }
            ...
            for (b = 0; b < 6 - linecode.length - m_c; b++) {
                out += "<td></td>";
            }
            out += "</tr>";
            t = 3;
            ...
            for (b = 0; b < linecode.length; b++) {
                if (b == 0) {
                    out += "<td style='color:" + color_custom_datatype + "'>"
                } else if (b == 2) {
                    out += "<td colspan='3' style='color:" + color_remark + "'>"
                } else {
                    out += "<td>";
                }
                if (linecode[b] != undefined) {
            ...
            for (b = 0; b < linecode.length; b++) {
                ...
                if (b == 0) {
                    out += "<td style='color:" + color_constant + "'>"
                } else if (b == 1) {
                    out += "<td style='color:" + color_constant_value + "'>"
                } else if (b == 3) {
                    out += "<td style='color:" + color_remark + "'>";
                } else {
                    out += "<td>"
            ...
            if (temp == "    .参数" || temp == "    .成员") { //Dll参数，数据类型成员
                ...
                for (b = 0; b < 5 - m_c - linecode.length; b++) {
                    out += "<td></td>";
                }
                out += "</tr>";
            } else { //代码区域
                ...
                if (temp.substr(0, 1) == ".") { //处理系统流程命令
                    ...
                    if (temp == "如果真") {
                        ...
                        all_sys--;
                        y_sys_e[all_sys] = y;
                        sys_line += "<div style='height:" + (y_sys_e[all_sys] - y_sys_s[all_sys] - 2)
                            .toString() + "px;width:19px;float:left;position:relative;top:" + (y_sys_s[all_sys] + 10 - 1)
                            .toString() + "px;left:" + (y_sys_l[all_sys] * 24 - x)
                            .toString() + "px;border-left:1px dashed " + color_sys_flowline + ";border-top:1px dashed " + color_sys_flowline + ";border-bottom:1px dashed " + color_sys_flowline_ignore + ";margin-right:4px'></div>";
                        x += 24;
                    } else if (temp == "判断开始") {
                        y_sys_s[all_sys] = y;
                        y_sys_e[all_sys] = y;
                        ...
                        all_sys--;
                        y_sys_e[all_sys] = y;
                        sys_line += "<div style='height:" + (y_sys_e[all_sys] - y_sys_s[all_sys] + 20 - 2)
                            .toString() + "px;width:19px;float:left;position:relative;top:" + (y_sys_s[all_sys] + 10)
                            .toString() + "px;left:" + (y_sys_l[all_sys] * 24 - x)
                            .toString() + "px;border-left:1px dashed " + color_sys_flowline + ";border-top:1px dashed " + color_sys_flowline + ";border-bottom:1px dashed " + color_sys_flowline + ";margin-right:4px'></div>";
                        x += 24;
                        temp_r = "";
                        y_sys_s[all_sys] = y;
                        y_sys_e[all_sys] = y;
                        ...
                        all_sys--;
                        y_sys_e[all_sys] = y;
                        sys_line += "<div style='height:" + (y_sys_e[all_sys] - y_sys_s[all_sys] - 1)
                            .toString() + "px;width:7px;float:left;position:relative;top:" + (y_sys_s[all_sys] + 10)
                            .toString() + "px;left:" + (y_sys_l[all_sys] * 24 - x + 12)
                            .toString() + "px;border-left:1px dashed " + color_sys_flowline + ";border-top:1px dashed " + color_sys_flowline + ";margin-right:4px'></div>";
                        x += 12;
                    ...
                    if (temp.indexOf("版本") == -1 && temp.indexOf("支持库") == -1) {
                        ...
                        if (p_a == -1) {
                            p_a = linetext[a].length - 1
                        }
                        temp_ = linetext[a].substr(p_a + 1)
                        temp_ = linetext[a].slice(_blank.length + 1 + temp.length, p_a + 1)
                            .replace(/[ ]/g, "&nbsp;") + ecode_highlight(temp_)
                        if (wm == 1) {
                            linetext[a] = _blank.replace(/[ ]/g, "&nbsp;") + "&nbsp;&nbsp;&nbsp;&nbsp;" + temp_r.fontcolor(color_sys_command_ignore) + temp_;
                        } else {
                            linetext[a] = _blank.replace(/[ ]/g, "&nbsp;") + "&nbsp;&nbsp;&nbsp;&nbsp;" + temp_r.fontcolor(color_sys_command) + temp_;
                        }
                        temp = linetext[a];
                    } else {
                        temp = ""
                    ...
                    temp = ecode_highlight(linetext[a]);
                }
                if (t >= 0) {
                    out += "</table>";
                    t = -1;
                ...
                if (temp != "") {
                    out += "<div class='e_code_codeline'>" + temp + "</div>";
                    y += 18;
                }
            }
        }
    ...
    out = "<div class='e_code_e_code'><div id='data_" + divid + "' class='e_code_data'></div><div class='e_code_codecontainer'><div class='e_code_codearea' id='codearea_" + divid + "' style='height:" + (y)
        .toString() + "px;width:100%'>" + out + "<div style='height:" + y.toString() + "px;float:left;clear:left;position:relative;top:-" + y.toString() + "px;'>" + sys_line + "</div></div></div></div>";
...
function ecode_highlight(codeline) {
    ...
    while (p_a != -1) {
        ...
        for (e = p_a; e < temp.length; e++) {
            if (illstr.indexOf(";" + temp.substr(e, 1) + ";") != -1) {
                p_b = e;
                break;
            }
        }
    ...
    for (e = 0; e < temp.length; e++) {
        if (numstr.indexOf(temp.charAt(e)) != -1 && k == 0) {
            if (temp.charAt(e - 1) == "#" || illstr.indexOf(temp.charAt(e - 1)) == -1) {
                k_ = 1
            } else {
                num_s[all_num + 1] = e;
                num_e[all_num + 1] = -1;
    ...
    while (p_a != -1) {
        ...
        if (!inquto(temp, p_b)) {
            ...
            if (inquto(temp, p_c) || p_c == -1) {
                temp_ = temp.slice(p_a, p_b)
                if (temp_ == "返回" || temp_ == "跳出循环" || temp_ == "到循环尾" || temp_ == "结束") {
                    temp_ = temp_.fontcolor(color_sys_command);
                } else {
                    temp_ = temp_.fontcolor(color_code_command);
                }
                temp = temp.slice(0, p_a) + temp_ + temp.substr(p_b);
            }
        }
